...
1. [Background:](#markov-chain-monte-carlo-mcmc-centeredslide)
2. [Documentation](#sec-l2hmc)
    - [Wiki](#sec-su3)
    - [Box](#sec-results)
    - [Outlook](#sec-extras)
3. [Monday.com](#sec-references)
4. [Overleaf](#sec-extras)
5. [Whiteside's](#whitesides)


# Background {.centeredslide}
...
- Use the Insert Figure button(![](https:​/​/​sharelatex-wiki-cdn-671420.c.cdn77.org/​learn-scripts/​images/​a/​a8/​InsertFigureButton.png){width=75%}), located on the editor toolbar, to insert an image into Visual Editor or Code Editor.
