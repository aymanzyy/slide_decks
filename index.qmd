...
# {.title-slide .centeredslide background-image="assets/RL_Chapel_Photo.jpg"}
...
<span style="color:#FCF7E5; font-size:1.5em; font-weight: bold;">Workshop 1: Introduction to the Randles Lab</span>  
<span style="color:#E5E5E5; font-size:1.2em; font-weight: bold;">Getting started with our different tools</span>  
[<br>&nbsp;]{style="padding-bottom: 0.5rem;"}  
[{{< fa solid home >}}](https://aymanzyy.github.io) <span style="color:#E5E5E5; font-size:1.2em; font-weight: bold;">Ayman Yousef </span> 
:::

::: footer
[2025-09-05 @ [Randles Lab Workshop Series](https://randleslab.pratt.duke.edu)]{.dim-text style="text-align:left;'}
:::
...
# Why Are We So Structured {#wecare .centeredslide}
...
# Lab Policies {#labpolicies .centeredslide}

:::: {.columns}

::: {.column width="50%"}

- <span style="color:#3f3244;">**Code**</span>: 
    - HARVEY is proprietary. It should live only on Randles Lab provided and approved laptops or approved systems like those at DOE. 
    - Do not put snippets into any LLM or AI software, share video, etc. Please discuss with PI before distribution or sharing of any code. 
    - All lab-developed code and analysis scripts are considered proprietary and may not be shared externally without PI approval.
:::

::: {.column width="49%"}

- <span style="color:#2f2235;">**Lab Tasks**</span>: Just like wet labs share tasks like cleaning or buffer prep, our dry lab relies on everyone pitching in on share maintenance duties that keep our computational setup strong and productive.


::: {.fragment .fade-in-then-out-out}
::: {.callout-warning title="Warning!"}
- Do the lab tasks, as these are an easy way to build rep with your fellow labmates and Prof. Randles
:::
:::
...
# Meetings {#meetings .centeredslide}

:::: {.columns}

::: {.column width="50%"}

- <span style="color:#3f3244;">**Project meetings**</span>: deep dive into project updates and technicaldetails, bi-weekly. These meetings are the main research updates.You should be attended 1-2 depending on your stage.

- <span style="color:#2f2235;">**Individual meetings**</span>: high-level planning, career discussions,course plans, IDP, deep planning for research project trajectory,extended discussions that need follow up from project meeting (this will typically be called out in project meeting), for the last two all relevant parties should sign up. Meeting agendas should be in yourBox folder 24 hours before the meeting

:::

::: {.column width="49%"}

- <span style="color:#3f3244;">**Group meeting**</span>: time to share announcements, give quick update on weekly goals (note: this is not a technical update), opportunity for an extended deep dive on one project.
- <span style="color:#2f2235;"> **Scrums**</span>: project management meeting, should be a quick non-technical meeting, each person should share their monday ‘My Work’section, state their goal for the week, and go over the plan to achieve it. Discuss if the goal is in line with overall project timeline/plan and targeted tasks are reasonable.

:::
::::

# Documents {#docs .centeredslide}

Professor Randles just laid out updated SOPs, good to read in depth 

![](assets/path_to_sops.png){width=90%}

## Documents, Publications {.centeredslide}

![](assets/lab_sop_publications.png){width=90%}


## Documents, Mentoring/Expectations {.centeredslide}

![](assets/lab_sop_expectations.png){width=90%}

## Documents, Agenda Setup {.centeredslide}

![](assets/lab_sop_agenda_guide.png){width=90%}
...
::: {.fragment .fade-in-then-out-out}
![](https://i.gyazo.com/aa354f6cbe0674f3380a29270af9cd33.png){width=60%}
:::
...
::: {.column width="50%"}
 ...
 - We use Outlook calendar to organize our lab schedule. This includes:
    ...
    - Milestone Events
    - Time Off
- New this year is the two calendar system. Remember to update the "Time-Off" calendar 
    - Classes
    - Planned vacations
...
## Outlook, Meetings Overview 


![](https://i.gyazo.com/cadbca20725120ffc1d68cb6b99d30b2.png){width=75%}


## Outlook Time-Off Overview 

![](assets/out_of_office_calendar.png){width=65%}
...
::: {.column width="49%"}
![](assets/monday_logo.png){width=75%}
...
::: {.column width="48%"}
- <span style="color:#A1B70D;">**Resources** </span>
  - Instructions/Tutorials for using Monday
  - Contacts
  - Project List

- <span style="color:#005587;">**Miscellaneous Work** </span>
...
- <span style="color:#C84E00;">**Instructions** </span>
...
- <span style="color:#262626;">**Link** </span>
